...
using Nebx.API.BuildingBlocks.Infrastructure.Extensions;
using Nebx.API.BuildingBlocks.Shared.Contracts.DDD;

namespace Nebx.API.BuildingBlocks.Infrastructure.Interceptors;

public class TimeAuditEntityInterceptor : SaveChangesInterceptor
{
